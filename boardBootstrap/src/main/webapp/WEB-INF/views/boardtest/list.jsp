...
<body>
		...
		<div class="form-control border-0 small position-relative" style="height:50px">
        	<div class="position-absolute bottom-0 end-0">
	            ...
	            <select name="search" id="">
	          	...
	          	<input type="submit" value="검색" class="btn btn-secondary opacity-75" id="search">
        	</div>
        </div>
	</form>
	...
	<!-- <form id="actionForm1" action="/b/boardtest/write">
		<div class="text-end">
		   <input type="submit" value="글쓰기" class="btn btn-outline-secondary" id="writeList">
		</div>
	</form> -->
	
	<div class="text-end">
		<a href="/b/boardtest/write" class="btn btn-outline-secondary">글쓰기</a>
	</div>
